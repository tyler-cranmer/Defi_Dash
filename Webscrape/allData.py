...
# 'Magic_Internet_Money(MIM)',
# 'dYdX(DYDX)', 
# 'yearn.finance(YFI)','Curve_DAO_Token_(CRV)', 'renBTC(RENBTC)', 'Spell_Token_(SPELL)', 'REN_(REN)',
# 'Nexus Mutual_(NXM)',
#  'Perpetual Protocol_(PERP)',
#   'Serum_(SRM)', 
#   'Bancor_Network_Token_(BNT)',
#    'xSUSHI_(XSUSHI)', '0x_(ZRX)', 'Raydium_(RAY)', 'UMA_(UMA)', 
# 'Coin98 (C98)', 
# 'Wonderland_(TIME)',
#  'Liquity_USD_(LUSD)', '1inch_(1INCH)', 'Neutrino_USD_(USDN)', 'Loopring_(LRC)', 'Fei_Protocol_(FEI)', 'Kava(KAVA)', 'Rocket_Pool(RPL)',
# 'Gnosis(GNO)', 
# 'Reserve_Rights_Token_(RSR)', 'Alpha Finance_(ALPHA)', 
# 'Frax_(FRAX)', 'Convex_Finance_(CVX)',
#  'Rari_Governance_Token_(RGT)', 'Keep Network (KEEP)', 'sETH (SETH)', 'Injective Protocol (INJ)',
